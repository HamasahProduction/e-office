...
class SuratKeteranganPendaftaranHajiController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('landing-page.layanan_umum.surat_keterangan_pendaftaran_haji.index', compact('desa','surat','account'));
    }
    public function pengajuan(Request $request)
    {
        ...
        if(!$data)
        {
            ...
            return redirect()->route('lp.layanan-umum.surat-keterangan-pendaftaran-haji.index')->with('errorpengajuan',$error);
        }
