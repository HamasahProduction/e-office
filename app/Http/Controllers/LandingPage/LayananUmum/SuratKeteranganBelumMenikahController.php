...
class SuratKeteranganBelumMenikahController extends Controller
{
    public function index()
    {
        ...
        return view('landing-page.layanan_umum.surat_keterangan_belum_menikah.index', compact('desa','surat','account'));
    }
    ...
    public function pengajuan(Request $request)
    {
        ...
        if(!$data)
        {
            ...
            return redirect()->route('lp.layanan-umum.surat-keterangan-belum-menikah.index')->with('errorpengajuan',$error);
        }
