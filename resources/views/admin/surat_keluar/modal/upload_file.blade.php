<div class="modal fade" id="upload_file_{{ $suratKeluar->id }}" data-bs-backdrop="static" data-bs-keyboard="false"
    tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-full-width">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="staticBackdropLabel">File : {{ $suratKeluar->perihal }}</h5>
            </div>

            <form action="{{ route('app.admin.surat-keluar.lampiran') }}" method="post" enctype="multipart/form-data">
                @csrf
