...
@section('content')
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card">
                <form action="{{ route('app.admin.surat.skbp.update', $skbp->id) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    <select name="nik" id="nik"
                                        ...
                                        <option value="{{ $penduduk->nik }}" {{ $penduduk->nik ==$skbp->nik?'selected':'' }}>NIK : {{ $penduduk->nik }} | {{ $penduduk->nama_lengkap }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    <input type="date" name="tgl_surat" maxlength="255" minlength="5"
                                        ...
                                        value="{{ old('tgl_surat', $skbp->tgl_surat) }}">
                                    <div class="invalid-feedback">
                                        @error('tgl_surat')
                                            {{ $message }}
                                        @enderror
                        ...
                        <div class="card-footer text-end">
                            ...
                            <a href="{{ route('app.admin.surat.skbp.index') }}" class="btn btn-secondary me-2">Kembali</a>
