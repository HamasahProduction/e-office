...
@section('content')
    @component('components.breadcrumb')
        ...
        @endslot
        @slot('action_button')
            <a href="{{ route('app.admin.surat-keterangan-kematian-lama.create') }}" class="btn btn-primary btn-md">
                        ...
                        <div class="row filter-row">
                            ...
                            <div class="col-md-8 col-12">
                                <div class="col-md-8 float-start">
                                    <button type="submit"
                                        onclick="javascript: form.action='{{ route('app.admin.surat-keterangan-kematian-lama.index') }}';"
                                                    ...
                                                    <div class="btn-group">
                                                        ...
                                                        <div class="dropdown-menu" style="">
                                                            <a class="dropdown-item btn-cetak-kades" href="#"
                                                                ...
                                                                data-url="{{ route('app.admin.surat-keterangan-kematian-lama.cetak') }}">Kepala
                                                                Desa</a>
                                                            <a class="dropdown-item btn-cetak-an" href="#"
                                                                data-id="{{ $pemohon->no_urut_surat }}"
                                                                data-url="{{ route('app.admin.surat-keterangan-kematian-lama.cetak') }}">Sekertaris
                                                                Desa</a>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                                    <a href="{{ route('app.admin.surat-keterangan-kematian-lama.edit', $pemohon->id) }}"
                                                        class="btn btn-sm btn-warning">
                                                        Edit
                                                    </a>
                                                    @if ($pemohon->penduduk->is_live == true)
                                                        <button type="button"
                                                            data-action="{{ route('app.admin.surat-keterangan-kematian-lama.update.kependudukan', $pemohon->id) }}"
                                                            data-id="{{ $pemohon->id }}"
