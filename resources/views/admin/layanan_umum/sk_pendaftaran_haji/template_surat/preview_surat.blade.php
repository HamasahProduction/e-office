...
<head>
    ...
    <title>Surat Keterangan Pendaftaran Haji</title>
    <style>
        body {
...
<body>
    <div class="container-surat">
        ...
        <div style="font-size: 18px; text-align:center; padding-bottom:15px; padding-top:5px;">
            <strong><u>SURAT KETERANGAN PENDAFTARAN HAJI</u></strong> <br>
            ...
            <table style="100%">
                ...
                <tr>
                    <td style="padding-top:15px;">
                        Orang tersebut diatas benar Penduduk/Warga Desa Kami, dan saat ini akan melakukan <strong>pendaftaran jamaah haji.</strong>
                    </td>
                </tr>
                <tr>
                    <td style="padding-top:15px;">
                ...
                <tr>
                    <td style="width: 30%;">
                        <table style="text-align: center">
                            <tr>
                                <td>Mengetahui, <br>Camat Kecamatan Cibeureum</td>
                            </tr>
                            <tr>
                                <td>Kepala Desa Cimara</td>
                            </tr>
                            <tr>
                                <td style="padding-top: 70px"><strong>NANA KUSMANA, S.Sos, MM</strong><br>Pembina TK. I <br>NIP : 19660504 199703 1 003</td>
                            </tr>
                        </table>
                    </td>
                    ...
                    <td style="width: 30%;">
                        <table style="text-align: center">
                            ...
                            <tr>
                                <td style="padding-top: 90px"><strong>RUSKANDA</strong></td>
                            </tr>
                        </table>
                    </td>
                </tr>
