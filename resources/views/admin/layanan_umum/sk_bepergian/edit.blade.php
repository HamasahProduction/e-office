...
@section('content')
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card">
                <form action="{{ route('app.admin.surat.skb.update', $skb->id) }}" method="post"
                                    ...
                                    <select name="nik" id="nik"
                                        ...
                                        @foreach ($penduduks as $penduduk)
                                            <<option value="{{ $penduduk->nik }}"
                                                {{ $penduduk->nik == $skb->nik ? 'selected' : '' }}>NIK : {{ $penduduk->nik }} |
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    <input type="text" name="kepentingan" maxlength="255" minlength="5"
                                        ...
                                        value="{{ old('kepentingan', $skb->kepentingan) }}">
                                    <div class="invalid-feedback">
                                        @error('kepentingan')
                                            {{ $message }}
                                        @enderror
                                    ...
                                    <select required name="province_id" id="province_id"
                                        ...
                                        @foreach ($province as $item)
                                            <option value="{{ $item->id }}"
                                                {{ $item->id == $skb->province_id ? 'selected' : '' }}>{{ $item->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                    <div class="invalid-feedback">
                                ...
                                <div class="col-lg-9">
                                    <select class="select2 regency form-control @error('regency_id') is-invalid @enderror"
                                        ...
                                        @foreach ($regency as $item)
                                            <option value="{{ $item->id }}"
                                                {{ $skb->regency_id == null ? '' : ($item->id == $skb->regency_id ? 'selected' : '') }}>
                                                {{ $item->name }}</option>
                                        @endforeach
                                    </select>
                                    <div class="invalid-feedback">
                                ...
                                <div class="col-lg-9">
                                    <select required name="district_id" id="district_id"
                                        ...
                                        @foreach ($district as $item)
                                                <option value="{{ $item->id }}"
                                                    {{ $skb->district_id==null?'':($item->id == $skb->district_id ? 'selected' : '' )}}>
                                                    {{ $item->name }}</option>
                                            @endforeach
                                    </select>
                                    <div class="invalid-feedback">
                                ...
                                <div class="col-lg-9">
                                    <select required name="village_id" id="village_id"
                                        ...
                                        @foreach ($village as $item)
                                                <option value="{{ $item->id }}"
                                                    {{ $skb->village_id==null?'':($item->id == $skb->village_id ? 'selected' : '') }}>
                                                    {{ $item->name }}</option>
                                            @endforeach
                                    </select>
                                    <div class="invalid-feedback">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    <input type="date" name="tgl_surat" maxlength="255" minlength="5"
                                        ...
                                        value="{{ old('tgl_surat', $skb->tgl_surat) }}">
                                    <div class="invalid-feedback">
                                        @error('tgl_surat')
                                            {{ $message }}
                                        @enderror
