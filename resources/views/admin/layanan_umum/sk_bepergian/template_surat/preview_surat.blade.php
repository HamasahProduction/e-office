            ...
            <table style="100%">
                ...
                <tr>
                    <td style="padding-top:15px;">
                        Benar bahwa yang bersangkutan warga Desa Cimara Kecamatan Cibeureum Kabupaten Kuningan dan yang bersangkutan sedang bepergian ke <strong id="tujuan">Bandung</strong> untuk kepentingan <strong id="kepentingan">meeting</strong>
                    </td>
                </tr>
                <tr>
                    <td style="padding-top:15px;">
