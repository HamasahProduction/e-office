...
<body>
    <div class="container-surat" style="font-family: 'Times New Roman', Times, serif;">
        ...
        <div style="font-size: 18px; text-align:center; padding-bottom:15px; padding-top:5px;">
            <strong><u>SURAT KETERANGAN BEPERGIAN</u></strong> <br>
            ...
            <table style="100%">
                ...
                <tr>
                    <td style="padding-top:15px;">
                        Benar bahwa yang bersangkutan warga Desa Cimara Kecamatan Cibeureum Kabupaten Kuningan dan yang bersangkutan sedang bepergian ke <strong id="tujuan_an">Bandung</strong> untuk kepentingan <strong id="kepentingan_an">meeting</strong>
                    </td>
                </tr>
                <tr>
                    <td style="padding-top:15px;">
