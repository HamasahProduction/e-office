                            ...
                            <td style="padding-left: 25px;">
                                <table>
                                    <tr>
                                        ...
                                        <td class="text-start" style="font-size: 10px;">Pekerjaan</td>
                                    </tr>
                                    <tr>
                                        <td style="font-size: 10px;">2.</td>
                                        <td class="text-start" style="font-size: 10px;">Pendidikan</td>
                                    </tr>
                                </table>
                            </td>
                            <td style="padding-left: 25px;">
                                <table>
                                    <tr>
                                        ...
                                        <td class="text-start" style="font-size: 10px;">Keamanan</td>
                                    </tr>
                                    <tr>
                                        <td style="font-size: 10px;">4.</td>
                                        <td class="text-start" style="font-size: 10px;">Kesehatan</td>
                                    </tr>
                                </table>
                            </td>
                            <td style="padding-left: 25px;">
                                <table>
                                    <tr>
                                        ...
                                        <td class="text-start" style="font-size: 10px;">Perumahan</td>
                                    </tr>
                                    <tr>
                                        <td style="font-size: 10px;">6.</td>
                                        <td class="text-start" style="font-size: 10px;">Keluarga</td>
                                    </tr>
                                </table>
                            </td>
                            <td style="padding-left: 25px;">
                                <table>
                                    <tr>
                                        ...
                                        <td class="text-start" style="font-size: 10px;">Lainya (sebutkan)
                                        </td>
                                    </tr>
                                </table>
                            </td>
                    ...
                    <table>
                        <tr>
                            <td style="width:100%;">
                                <table>
                                    <tr>
                                        <td style="width: 65%;font-size: 11px;">Kode Pos</td>
                                        <td >
                                            <table>
                                                <tr>
                                                    <td
                                                        style="border: 1px solid black; padding-left:5px; padding-right:5px; font-size: 11px;">
                                                        {{ $kodePosTujuanArray[0] }}
                                                    </td>
                                                    <td
                                                        style="border: 1px solid black; padding-left:5px; padding-right:5px; font-size: 11px;">
                                                        {{ $kodePosTujuanArray[1] }}
                                                    </td>
                                                    <td
                                                        style="border: 1px solid black; padding-left:5px; padding-right:5px; font-size: 11px;">
                                                        {{ $kodePosTujuanArray[2] }}
                                                    </td>
                                                    <td
                                                        style="border: 1px solid black; padding-left:5px; padding-right:5px; font-size: 11px;">
                                                        {{ $kodePosTujuanArray[3] }}
                                                    </td>
                                                    <td
                                                        style="border: 1px solid black; padding-left:5px; padding-right:5px; font-size: 11px;">
                                                        {{ $kodePosTujuanArray[4] }}
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                                                        ...
                                                        <table>
                                                            <tr>
                                                                @foreach ($noHpArray as $hp)
                                                                    <td
                                                                        style="border: 1px solid black; padding-left:7px; padding-right:7px; font-size: 11px;">
                                                                        {{ $hp }}
                                                                    </td>
                                                                @endforeach
                                                            </tr>
