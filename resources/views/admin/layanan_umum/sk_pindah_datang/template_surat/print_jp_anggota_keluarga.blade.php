<div id="printable" style="display: none">
    <div class="col-lg-12">
        ...
        @include('admin.layanan_umum.sk_pindah_datang.template_surat.data_kepindahan.seluruh_anggota.data_kepindahan')
        {{-- anggota keluarga --}}
        <div class="row mt-2">
            <div class="col-lg-12">
                <table style="width:100%; text-align: center;">
                    ...
                    <tbody style="border: 1px solid black">
                        @foreach ($detailAnggota as $index => $anggota)
                            <tr style="border: 1px solid black; font-size: 11px;">
                                <td style="border: 1px solid black;">{{ $index + 1 }}</td>
                                @php
                                    $nikDigits = str_split($anggota->nik);
                                @endphp
                                @foreach ($nikDigits as $digit)
                                    <td style="border: 1px solid black; font-size: 11px;">{{ $digit }}</td>
                                @endforeach
                                @for ($i = count($nikDigits); $i < 16; $i++)
                                    <td style="border: 1px solid black; font-size: 11px;">0</td>
                                @endfor
                                <td style="border: 1px solid black; font-size: 11px;">{{ $anggota->nama }}</td>
        ...
        @include('admin.layanan_umum.sk_pindah_datang.template_surat.daerah_tujuan.data_daerah_tujuan')
    </div>
</div>
