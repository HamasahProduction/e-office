            ...
            <table style="100%">
                ...
                <tr>
                    <td style="padding-top:15px;">
                        Terdapat perbedaan nama pada <strong><i id="keterangan_beda"></i></strong> :
                    </td>
                </tr>
                <tr>
                    <td>
                        <table>
                            <tr>
                                <td style="width: 200px;" id="dokumen_berbeda"></td>
                                <td style="padding-right: 5px;">:</td>
                                <td><strong id="perbedaan_nama"> value.nama </strong></td>
                            </tr>
                        </table>
                        <table>
                            <tr id="list_perbedaan"></tr>
                        </table>
                    </td>
                </tr>
                <tr>
                    <td style="padding-top:15px;">
                        Dalam <strong id="jumlah_berkas">-</strong> berkas tersebut benar adalah orang yang sama dan
