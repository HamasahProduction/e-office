...
<body>
    <div class="container-surat" style="font-family: 'Times New Roman', Times, serif;">
        ...
        <div style="font-size: 18px; text-align:center; padding-bottom:15px; padding-top:5px;">
            <strong><u>SURAT KETERANGAN USAHA</u></strong> <br>
            ...
            <table style="100%">
                ...
                <tr>
                    <td style="padding-top:15px;">
                        Orang tersebut diatas adalah benar Penduduk/Warga Desa Cimara Kecamatan Cibeureum Kabupaten
                        Kuningan yang mempunyai usaha <strong id="nama_usaha_an">"Budidaya Ikan".</strong>
                    </td>
                </tr>
                <tr>
                    <td style="padding-top:15px;">
