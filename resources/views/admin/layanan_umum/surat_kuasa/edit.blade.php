...
@section('content')
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card">
                <form action="{{ route('app.admin.surat-kuasa.update', $surat->id) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    <input type="text" name="nama_ahli_waris" maxlength="255" minlength="5"
                                        ...
                                        value="{{ old('nama_ahli_waris', $surat->nama_ahli_waris) }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    <select name="nik_anggota_ahli_waris" id="nik_anggota_ahli_waris"
                                        ...
                                        <option value="{{ $penduduk->nik }}" {{ $penduduk->nik==$surat->nik_anggota_ahli_waris?'selected':'' }}>NIK : {{ $penduduk->nik }} | {{ $penduduk->nama_lengkap }}</option>
                                        @endforeach
                                    </select>
                                    <div class="invalid-feedback">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    <select name="nik_penerima_kuasa" id="nik_penerima_kuasa"
                                        ...
                                        <option selected disabled>--Pilih NIK Penduduk--</option>
                                        @foreach ($penduduks as $penduduk)
                                        <option value="{{ $penduduk->nik }}" {{ $penduduk->nik==$surat->nik_penerima_kuasa?'selected':'' }}>NIK : {{ $penduduk->nik }} | {{ $penduduk->nama_lengkap }}</option>
                                        @endforeach
                                    </select>
                                    <div class="invalid-feedback">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    <textarea name="keterangan" maxlength="255" minlength="5" required cols="30" rows="4"
                                        class="form-control @error('keterangan') is-invalid @enderror" value="{{ old('keterangan') }}">{{ $surat->keterangan }}</textarea>
                                    <div class="invalid-feedback">
                                        @error('keterangan')
                                            {{ $message }}
                                        @enderror
