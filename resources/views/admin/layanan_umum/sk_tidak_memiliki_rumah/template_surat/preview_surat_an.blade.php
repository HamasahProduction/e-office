...
<body>
    <div class="container-surat" style="font-family: 'Times New Roman', Times, serif;">
        ...
        <div style="font-size: 18px; text-align:center; padding-bottom:15px; padding-top:5px;">
            <strong><u>SURAT KETERANGAN TIDAK MEMILIKI RUMAH</u></strong> <br>
            ...
            <table style="100%">
                    ...
                    <td>
                        <table style="width: 100%; margin-bottom:10px; margin-top:5px;">
                            ...
                            <tr>
                                <td>Warganegara</td>
                                <td style="padding-right: 5px">:</td>
                                <td id="warganegara_an">Indonesia</td>
                            </tr>
                            <tr>
                                <td>Pekerjaan</td>
                                <td style="padding-right: 5px">:</td>
                                <td id="pekerjaan_an">Indonesia</td>
                            </tr>
                            <tr>
                                <td>Alamat</td>
                                <td style="padding-right: 5px">:</td>
                ...
                <tr>
                    <td style="padding-top:15px;">
                        Adalah benar salah seorang warga/penduduk Desa Cimara Kecamatan Cibeureum Kabupaten Kuningan Provinsi Jawa Barat dan pada saat ini, orang tersebut <strong>Belum Memiliki Rumah</strong>
                    </td>
                </tr>
                <tr>
                    <td style="padding-top:15px;">
