...
<body>
    <div class="container-surat">
        ...
        <div style="font-size: 18px; text-align:center; padding-bottom:15px; padding-top:5px;">
            <strong><u>SURAT KETERANGAN KELAHIRAN</u></strong> <br>
            <p id="no_surat">-</p>
        </div>
            ...
            <table style="100%">
                ...
                <tr>
                    <td style="padding-top:15px;">
                        Betul dilahirkan di Desa/Kelurahan Cimara Kecamatan Cibeureum Kabupaten Kuningan pada <strong
                            id="ttl_anak">-</strong>. Anak yang sah dari pasangan:
                    </td>
                </tr>
                <tr>
                    <td>
                        <table style="width: 100%; margin-bottom:10px; margin-top:5px;">
                            <tr>
                                <td style="width: 200px;">Suami</td>
                                <td style="padding-right: 5px">:</td>
                                <td><strong id="suami">-</strong></td>
                            </tr>
                            <tr>
                                <td>Istri</td>
                                <td style="padding-right: 5px">:</td>
                                <td><strong id="istri">-</strong></td>
                            </tr>
                        </table>
                    </td>
                </tr>
                ...
                <tr>
                    <td>1. Data yang terdapat di buku induk</td>
                </tr>
                <tr>
                    <td>2. Pengakuan yang berkepentingan yang telah menyadari bahwa pengakuan ini mengakibatkan
                        status hukum yang berkepentingan.</td>
                </tr>
                <tr>
                    <td style="padding-top:15px;">
                        <p>Demikian Surat Keterangan ini kami buat dengan sebenarnya agar dipergunakan sebagaimana
                            mestinya, sesuai dengan peraturan perundang-undangan yang berlaku.</p>
                    </td>
                </tr>
        ...
        {{-- <div class="footer-surat">
            <p>Jalan Raya Cimara - Cibeureum Kode Pos 45588 <br><a href="http://">Email:desacimara@gmail.com</a>
                <br>KECAMATAN CIBEUREUM KABUPATEN KUNINGAN 45565
            </p>
        </div> --}}
    </div>
</body>
