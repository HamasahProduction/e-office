...
@section('content')
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card">
                <form action="{{ route('app.admin.surat.skkm.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    <select name="nik_keperluan" id="nik_keperluan"
                                        ...
                                        <option selected disabled>--Pilih NIK Penduduk--</option>
                                        @foreach ($penduduks as $penduduk)
                                        <option value="{{ $penduduk->nik }}">{{ $penduduk->nama_lengkap }} | <strong>{{ $penduduk->nik }}</strong></option>
                                        @endforeach
                                    </select>
                                    <div class="invalid-feedback">
                                        @error('nik_keperluan')
