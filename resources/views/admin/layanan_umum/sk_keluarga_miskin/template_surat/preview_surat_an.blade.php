    ...
    <div class="container-surat" style="font-family: 'Times New Roman', Times, serif;">
        ...
        <div class="body-surat" style="text-align: justify;">
            <table style="100%">
                    ...
                    <td>
                        <table style="width: 100%; margin-bottom:10px; margin-top:5px;">
                            ...
                            <tr>
                                <td>Alamat</td>
                                <td style="padding-right: 5px">:</td>
                                <td id="alamat_an">Dusun Cimara RT 003 RW 002 Desa Cimara Kec. Cibeureum Kab. Kuningan
                                </td>
                            </tr>
                        </table>
                    </td>
                ...
                <tr>
                    <td style="padding-top:15px;">
                       Surat Keterangan ini dibuat untuk keperluan <strong id="nama_keperluan_an">berobat anak </strong> :
                    </td>
                </tr>
                <tr>
                    <td>
                        <table style="width: 100%; margin-bottom:10px; margin-top:5px;">
                            <tr>
                                <td style="width: 200px;">NIK</td>
                                <td style="padding-right: 5px">:</td>
                                <td><strong id="nik_keperluan_an">3208290305900005</strong></td>
                            </tr>
                            <tr>
                                <td>Nama</td>
                                <td style="padding-right: 5px">:</td>
                                <td><strong id="nama_orang_keperluan_an">IMAM WAHYUDI</strong></td>
                            </tr>
                            <tr>
                                <td>Tempat Tanggal Lahir</td>
                                <td style="padding-right: 5px">:</td>
                                <td id="ttl_keperluan_an">Kuningan, 03-05-1990</td>
                            </tr>
                            <tr>
                                <td>Jenis Kelamin</td>
                                <td style="padding-right: 5px">:</td>
                                <td id="jenis_kelamin_keperluan_an">Laki-Laki</td>
                            </tr>
                        </table>
                    </td>
                </tr>
