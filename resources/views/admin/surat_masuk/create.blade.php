...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <form action="{{ route('app.admin.surat-masuk.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label">Instansi Pengirim<span
                                            class="text-danger">*</span></label>
                                    <div class="col-lg-9">
                                        <input type="text" name="nama_instansi_pengirim" maxlength="255" minlength="5" required
                                            class="form-control @error('nama_instansi_pengirim') is-invalid @enderror"
                                            value="{{ old('nama_instansi_pengirim') }}">
                                        <div class="invalid-feedback">
