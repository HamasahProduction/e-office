...
@section('content')
    @component('components.breadcrumb')
        ...
        @endslot
        @slot('action_button')
            <a href="{{ route('app.admin.pengaturan.rt.create') }}" class="btn btn-primary btn-md">
                        ...
                        <div class="row filter-row">
                            <div class="col-md-6">
                                <div class="form-group form-group form-focus select-focus focused">
                                    <select class="select2 col-lg-12" name="dusun_id" id="dusun_id">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="col-md-8 float-start">
                                    <button type="submit"
                                        onclick="javascript: form.action='{{ route('app.admin.pengaturan.rt.rt') }}';"
                                    ...
                                    <tbody>
                                        @foreach ($rts as $item)
                                            <tr>
                                                ...
                                                <td>{{ $item->dusun }}</td>
                                                <td>
                                                    <a href="{{ route('app.admin.pengaturan.rt.edit', $item->id) }}"
                                                        class="btn btn-sm btn-warning">
                                                        Edit
                                                    </a>
                                                    {{-- <button type="button"
                                                        data-action="{{ route('app.admin.pengaturan.rt.remove', $item->id) }}"
