...
@section('content')
    ...
    <div class="row">
        <div class="col-sm-6">
            <div class="card">
                <form action="{{ route('app.admin.pengaturan.surat.update',[$pengaturan->id]) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                        <div class="row">
                            <div class="form-group row">
                                ...
                                <div class="col-lg-7">
                                    <input type="text" name="judul_surat" maxlength="255" minlength="5"
                                        ...
                                        value="{{ old('judul_surat', $pengaturan->judul_surat) }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-7">
                                    <input type="text" name="kode_surat" maxlength="255" minlength="3"
                                        ...
                                        value="{{ old('kode_surat', $pengaturan->kode_surat) }}">
                                    <div class="invalid-feedback">
                                        @error('kode_surat')
                                            {{ $message }}
                                        @enderror
                                ...
                                <div class="col-lg-7">
                                    <select name="is_ttd" id="is_ttd"
                                        ...
                                        @foreach ($ttds as $isttd)
                                            <option value="{{ $isttd->id }}" {{ $isttd->id == $pengaturan->is_ttd?'selected':'' }}>{{ $isttd->nama }} | Jabatan :
