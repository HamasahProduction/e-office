    ...
    <div class="col-lg-12 col-md-8">
        ...
        <div class="card border-0 shadow-sm mb-4">
            <div class="card-body p-lg-12">
                ...
                <form method="post" action="{{ route('lp.layanan-umum.surat-keterangan-pendaftaran-haji.pengajuan') }}">
                    @csrf
                    <div class="col-lg-12">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="mb-3">
                                    <h3 class="mb-0">Form Surat Keterangan Domisili</h3>
                                </div>
                            </div>
                            <div class="col-lg-6 mb-4">
                                ...
                                <input type="text" name="nik_pemohon" class="form-control" value="{{ $account->nik }}" readonly required />
