    ...
    <div class="col-lg-12 col-md-8">
        ...
        <div class="card border-0 shadow-sm mb-4">
            <div class="card-body p-lg-12">
                ...
                <form method="post" action="{{ route('lp.layanan-umum.surat-keterangan-belum-menikah.pengajuan') }}">
                    @csrf
                    <div class="col-lg-12">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="mb-3">
                                    <h3 class="mb-0">Form Surat Keterangan Belum Menikah</h3>
                                </div>
                            </div>
                            <div class="col-lg-6 mb-4">
                                ...
                                <input type="text" class="form-control" name="nik_pemohon" value="{{ $account->nik }}"
                                    readonly required />
