    ...
    <div class="col-lg-12 col-md-8">
        <div class="card border-0 mb-4 shadow-sm">
            <div class="card-body p-lg-5">
                <div class="mb-2 d-lg-flex align-items-center justify-content-between">
                    ...
                    {{-- <div class=" mt-lg-0 d-md-flex">
                        <form id="formCheck">
                            <div class="row g-2 mt-2">
                                <div class="col-lg-4 col-12">
                                    <input type="hidden" class="form-control" name="nik_cek" id="nik_cek"
                                        value="{{ auth()->user()->username }}">
                                    <div class="invalid-feedback">Silahkan Masukan NIK.</div>
                                </div>
                                <div class="col-lg-12 col-12">
                                    <div class="col-lg-12">
                                        <button type="button" form="formCheck"
                                            data-url="{{ route('lp.layanan-umum.surat-keterangan-tidak-mampu.check-nik') }}"
                                            class="btn btn-success btn-check-nik">Cek Status Kependudukan!</button>
                                    </div>
                                </div>
                            </div>
                        </form>
        ...
        <div class="card border-0 shadow-sm mb-4">
            <div class="card-body p-lg-12">
                ...
                <form method="post" action="{{ route('lp.layanan-umum.surat-keterangan-tidak-mampu.pengajuan') }}">
                    @csrf
                    <div class="col-lg-12">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="mb-3">
                                    <h3 class="mb-0">Form Surat Keterangan Tidak Mampu</h3>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="col-md-6 col-md-12 mb-4">
                                    ...
                                    <input type="text" class="form-control" name="nik" value="{{ $account->nik }}" readonly required />
                            ...
                            <div class="col-lg-6">
                                <div class="col-md-6 col-md-12 mb-4">
                                    ...
                                    <div class="invalid-feedback">masukan nama sekolah.</div>
                                </div>
                                <div class="col-md-6 col-md-12 mb-4">
                                    <label for="scheduleLastnameInput" class="form-label">
                                        Kelas
                                    ...
                                    <div class="invalid-feedback">masukan Kelas.</div>
                                </div>
                            </div>
                        </div>
                    </div>
