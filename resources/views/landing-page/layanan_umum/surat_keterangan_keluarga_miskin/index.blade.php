        ...
        @if (!empty($checkStatusKlg))
            <div class="card border-0 shadow-sm mb-4">
                <div class="card-body p-lg-12">
                    ...
                    <form method="post"
                        action="{{ route('lp.layanan-umum.surat-keterangan-keluarga-miskin.pengajuan') }}">
                        @csrf
                        <div class="col-lg-12">
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="mb-3">
                                        <h3 class="mb-0">Form Surat Keterangan Keluarga Miskin</h3>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    ...
                                    <div class="col-md-6 col-md-12 mb-4">
                                        ...
                                        <div class="invalid-feedback">masukan keperluan.</div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="col-md-6 col-md-12 mb-4">
                                        ...
                                        <input type="text" class="form-control" name="nik_peruntukan" required />
                                        <div class="invalid-feedback">masukan nik peruntukan.</div>
                                    </div>
                                    <div class="col-md-6 col-md-12 mb-4">
                                        <label class="form-label">
                                            Kontak
